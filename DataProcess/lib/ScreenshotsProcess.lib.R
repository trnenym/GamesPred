...
# Creates an RGB vector if the image is in greyscale and optionally reduces each of the 3 channels to the specified number of bins
...
# Returns a vector hue values (devided into 16 bins), and the average saturation and value of an image
