...
tags.relevant <- c("2D", "4X", "BoardGame", "CardGame", "CityBuilder", "Crafting", "Cyberpunk", "DatingSim", "Episodic", "FamilyFriendly", "Fantasy"
                   , "FemaleProonist", "Fighting", "FirstPerson", "Flight", "FPS", "HiddenObject", "Horror", "JRPG", "Medieval", "Noir", "Nudity"
                   , "OpenWorld", "Parkour", "PixelGraphics", "Platformer", "PointClick", "Puzzle", "Remake", "Retro", "Rhythm", "Roguelike", "Roguelite"
                   , "RTS", "Sandbox", "Scifi", "Short", "Space", "Stealth", "Steampunk", "StoryRich", "Superhero", "Survival", "SurvivalHorror"
                   , "ThirdPerson", "ThirdPersonShooter", "TowerDefense", "TurnBased", "TurnBasedStrategy", "VisualNovel", "WalkingSimulator"
                   , "WorldWarII", "Zombies")
